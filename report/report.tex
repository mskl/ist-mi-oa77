...
\begin{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{part1/figures/task1/1_-1.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
...
\begin{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{part1/figures/task2/2_-1.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
...
\begin{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{part1/figures/task3/3_-1.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
