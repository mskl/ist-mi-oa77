...
\begin{figure}[!htb]
\caption{Plotted positions and control signal for Task1.}
\label{fig:task1:graphs}
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-3.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-2.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_0.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_2.png}
\end{subfigure}
\end{figure}

\begin{table}[!htb]
\centering
\caption{Results of the Task1.}
\label{table:task1:res}
\begin{tabular}{ccr}
...
\begin{figure}[!htb]
\caption{Plotted positions and control signal for Task2.}
\label{fig:task2:graphs}
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-3.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-2.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_0.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_2.png}
\end{subfigure}
\end{figure}

\begin{table}[!htb]
\centering
\caption{Results of the Task2.}
\label{table:task2:res}
\begin{tabular}{ccr}
$\lambda$ & changes & standard deviation \\
\hline
-3 & 11 & 0.0075 \\
-2 & 10 & 0.0747 \\
-1 & 11 & 0.7021 \\
...
\begin{figure}[!htb]
\caption{Plotted positions and control signal for Task3.}
\label{fig:task3:graphs}
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-3.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-2.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_0.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_1.png}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_2.png}
\end{subfigure}
\end{figure}

\begin{table}[!htb]
\centering
\caption{Results of the Task3.}
\label{table:task3:res}
\begin{tabular}{ccr}
$\lambda$ & changes & standard deviation \\
\hline
-3 & 11 & 0.0107 \\
