...
\author{Group 25 \\ Matyas Skalicky 94904, Ana Carloina Lima 83993, \\Manuel Freitas 85246 and Carina Fernandes 84019}
\date{}
...
\begin{lstlisting}[language=Matlab, caption=CVX code for task 7., label=listing:task7:cvx]
cvx_begin
    variable x(4,T+1);
    variable u(2,T);
    minimize(0);
...
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task/3_-3.pdf}\hspace{0em}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-2.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
