...
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-3.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-2.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_-1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_0.pdf}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task1/1_2.pdf}
\end{subfigure}
\end{figure}
...
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-3.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-2.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_-1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_0.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task2/2_2.pdf}
\end{subfigure}
\end{figure}
...
\begin{subfigure}
    \centering
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-3.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-2.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_-1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_0.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_1.pdf}
    \includegraphics[width=0.5\linewidth]{part1/figures/task3/3_2.pdf}
\end{subfigure}
\end{figure}
